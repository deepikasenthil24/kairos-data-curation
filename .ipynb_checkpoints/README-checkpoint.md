...
└── kairos-data-curation/
    ...
    ├── inat_embeddings.ipynb         #
    ├── kairos_inat_valuation.ipynb   # Uses Kairos to curate iNat images
    ├── labels.csv                    # generated by ??? file
    ├── README.md                     # This document, repo info
    ...
    ├── train.csv                     # iNat images (not all we need), generated by ??? file
    └── val.csv                       # iNat images, generated by ??? file, **Not sure if this is needed if we just use cv** plus confusing with validation/clean data
